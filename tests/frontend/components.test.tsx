...
import { ContentPageList } from '@/app/(admin)/admin/content/_components/content-page-list';
import { TemplateList } from '@/app/(admin)/admin/templates/_components/template-list';
